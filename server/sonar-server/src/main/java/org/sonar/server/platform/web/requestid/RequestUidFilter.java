...
public class RequestUidFilter implements Filter {
  ...
  public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {
    ...
    RequestUidMDCStorageFactory requestUidMDCStorageFactory = platform.getContainer().getComponentByType(RequestUidMDCStorageFactory.class);

    try (RequestUidMDCStorage mdcStorage = requestUidMDCStorageFactory.put(requestUidGenerator.generate())) {
